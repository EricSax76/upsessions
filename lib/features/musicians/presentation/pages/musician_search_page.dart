...
import '../../../user_home/presentation/widgets/search/advanced_search_box.dart';
          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final filterWidth = isWide ? constraints.maxWidth * 0.32 : constraints.maxWidth;
                ...
                final resultsList = BlocBuilder<MusicianSearchCubit, MusicianSearchState>(
