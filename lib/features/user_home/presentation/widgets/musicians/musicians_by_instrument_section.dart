...
class MusiciansByInstrumentSection extends StatefulWidget {
  ...
  @override
  State<MusiciansByInstrumentSection> createState() => _MusiciansByInstrumentSectionState();
}

class _MusiciansByInstrumentSectionState extends State<MusiciansByInstrumentSection> {
  ...
  Widget build(BuildContext context) {
    ...
    for (final category in widget.categories) {
      chips.add(Text(category.category, style: Theme.of(context).textTheme.titleSmall));
      chips.addAll(
    ...
    final filtered = _selectedInstrument == null
        ? widget.musicians
        : widget.musicians.where((m) => m.instrument == _selectedInstrument).toList();
