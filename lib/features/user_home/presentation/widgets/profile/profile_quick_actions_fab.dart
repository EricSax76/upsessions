  ...
  Widget build(BuildContext context) {
    final actions = [
      _FabActionButton(
        ...
        label: 'Nuevo anuncio',
        onPressed: () => _onAction(() => Navigator.of(context).pushNamed(AppRoutes.announcements)),
      ),
      _FabActionButton(
...
class _FabActionButton extends StatelessWidget {
  const _FabActionButton({required this.icon, required this.label, required this.onPressed});
