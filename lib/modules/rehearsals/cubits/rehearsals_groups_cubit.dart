...
part 'rehearsals_groups_state.dart';

class RehearsalsGroupsCubit extends Cubit<RehearsalsGroupsState> {
  RehearsalsGroupsCubit({required GroupsRepository repository})
      : _repository = repository,
        super(const RehearsalsGroupsState()) {
