...
class RehearsalsRepositoryBase {
  ...
  CollectionReference<Map<String, dynamic>> rehearsals(String groupId) =>
      groupDoc(groupId).collection('rehearsals');

  CollectionReference<Map<String, dynamic>> invites(String groupId) =>
      groupDoc(groupId).collection('invites');

  CollectionReference<Map<String, dynamic>> setlist(
    String groupId,
    String rehearsalId,
  ) => rehearsals(groupId).doc(rehearsalId).collection('setlist');
}
