...
class _EditRoomPageState extends State<EditRoomPage> {
  ...
  final _equipmentController =
      TextEditingController(); // Comma separated for MVP
                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 24),
                      ElevatedButton(
                        onPressed: state.status == StudiosStatus.loading
                            ? null
                            : () {
                                if (_formKey.currentState?.validate() ??
                                  ...
                                  context.read<MyStudioCubit>().createRoom(
                                    room,
                                  );
                                }
                              },
