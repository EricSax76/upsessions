...
class EventBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Stack(
        children: [
          _BannerBackground(imageUrl: imageUrl, hasImage: hasImage),
          if (hasImage) _BannerScrimOverlay(),
          Positioned.fill(
...
class _BannerBackground extends StatelessWidget {
  const _BannerBackground({required this.imageUrl, required this.hasImage});
...
class _BannerScrimOverlay extends StatelessWidget {
  const _BannerScrimOverlay();
...
class _BannerContent extends StatelessWidget {
  const _BannerContent({required this.hasImage, required this.eventTitle});
...
class _BannerUploadButton extends StatelessWidget {
  const _BannerUploadButton({
