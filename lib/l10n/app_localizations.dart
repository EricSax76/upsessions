...
abstract class AppLocalizations {
  ...
  /// No description provided for @venueShellBrandName.
  ///
  /// In es, this message translates to:
  /// **'UpSessions Venues'**
  String get venueShellBrandName;

  /// No description provided for @venueMenuDashboard.
  ///
  /// In es, this message translates to:
  /// **'Dashboard'**
  String get venueMenuDashboard;

  /// No description provided for @venueMenuNewVenue.
  ///
  /// In es, this message translates to:
  /// **'Nuevo local'**
  String get venueMenuNewVenue;

  /// No description provided for @venueMenuExploreVenues.
  ///
  /// In es, this message translates to:
  /// **'Explorar venues'**
  String get venueMenuExploreVenues;

  /// No description provided for @venueMenuLogout.
  ///
  /// In es, this message translates to:
  /// **'Cerrar sesión'**
  String get venueMenuLogout;

  /// No description provided for @venueBottomNavPanel.
  ///
  /// In es, this message translates to:
  /// **'Mi panel'**
  String get venueBottomNavPanel;

  /// No description provided for @venueBottomNavExplore.
  ///
  /// In es, this message translates to:
  /// **'Explorar'**
  String get venueBottomNavExplore;

  /// No description provided for @venuePublicListTitle.
  ///
  /// In es, this message translates to:
  /// **'Locales de espectáculos'**
  String get venuePublicListTitle;

  /// No description provided for @venueFiltersApply.
  ///
  /// In es, this message translates to:
  /// **'Filtrar'**
  String get venueFiltersApply;

  /// No description provided for @venueFieldCity.
  ///
  /// In es, this message translates to:
  /// **'Ciudad'**
  String get venueFieldCity;

  /// No description provided for @venueFieldProvince.
  ///
  /// In es, this message translates to:
  /// **'Provincia'**
  String get venueFieldProvince;

  /// No description provided for @venueLoadMore.
  ///
  /// In es, this message translates to:
  /// **'Cargar más'**
  String get venueLoadMore;

  /// No description provided for @venueRetry.
  ///
  /// In es, this message translates to:
  /// **'Reintentar'**
  String get venueRetry;

  /// No description provided for @venuePublicEmpty.
  ///
  /// In es, this message translates to:
  /// **'No hay locales disponibles con los filtros aplicados.'**
  String get venuePublicEmpty;

  /// No description provided for @venueManagerEmpty.
  ///
  /// In es, this message translates to:
  /// **'No tienes locales activos.'**
  String get venueManagerEmpty;

  /// No description provided for @venueManagerDeactivateTitle.
  ///
  /// In es, this message translates to:
  /// **'Desactivar local'**
  String get venueManagerDeactivateTitle;

  /// No description provided for @venueManagerDeactivateMessage.
  ///
  /// In es, this message translates to:
  /// **'¿Quieres desactivar \"{venueName}\"?'**
  String venueManagerDeactivateMessage(String venueName);

  /// No description provided for @venueManagerDeactivateAction.
  ///
  /// In es, this message translates to:
  /// **'Desactivar'**
  String get venueManagerDeactivateAction;

  /// No description provided for @venueManagerNewVenue.
  ///
  /// In es, this message translates to:
  /// **'Nuevo local'**
  String get venueManagerNewVenue;

  /// No description provided for @venueManagerHeadingTitle.
  ///
  /// In es, this message translates to:
  /// **'Mis locales'**
  String get venueManagerHeadingTitle;

  /// No description provided for @venueCardCapacityLabel.
  ///
  /// In es, this message translates to:
  /// **'Aforo {capacity}'**
  String venueCardCapacityLabel(int capacity);

  /// No description provided for @venueCardPublic.
  ///
  /// In es, this message translates to:
  /// **'Público'**
  String get venueCardPublic;

  /// No description provided for @venueCardPrivate.
  ///
  /// In es, this message translates to:
  /// **'Privado'**
  String get venueCardPrivate;

  /// No description provided for @venueCardSourceStudioSync.
  ///
  /// In es, this message translates to:
  /// **'Studio sync'**
  String get venueCardSourceStudioSync;

  /// No description provided for @venueCardSourceNative.
  ///
  /// In es, this message translates to:
  /// **'Nativo'**
  String get venueCardSourceNative;

  /// No description provided for @venueCardEdit.
  ///
  /// In es, this message translates to:
  /// **'Editar'**
  String get venueCardEdit;

  /// No description provided for @venueCardDeactivate.
  ///
  /// In es, this message translates to:
  /// **'Desactivar'**
  String get venueCardDeactivate;

  /// No description provided for @venueLoginTitle.
  ///
  /// In es, this message translates to:
  /// **'Acceso Venues'**
  String get venueLoginTitle;

  /// No description provided for @venueLoginSubtitle.
  ///
  /// In es, this message translates to:
  /// **'Gestiona tus locales y disponibilidad.'**
  String get venueLoginSubtitle;

  /// No description provided for @venueLoginRegisterPrompt.
  ///
  /// In es, this message translates to:
  /// **'¿No tienes cuenta? Regístrate'**
  String get venueLoginRegisterPrompt;

  /// No description provided for @venueRegisterTitle.
  ///
  /// In es, this message translates to:
  /// **'Registro Venues'**
  String get venueRegisterTitle;

  /// No description provided for @venueRegisterSubtitle.
  ///
  /// In es, this message translates to:
  /// **'Crea tu cuenta para gestionar locales y disponibilidad.'**
  String get venueRegisterSubtitle;

  /// No description provided for @venueRegisterVenueNameLabel.
  ///
  /// In es, this message translates to:
  /// **'Nombre del local o empresa'**
  String get venueRegisterVenueNameLabel;

  /// No description provided for @venueRegisterVenueNameHint.
  ///
  /// In es, this message translates to:
  /// **'Ej. Sala Horizonte'**
  String get venueRegisterVenueNameHint;

  /// No description provided for @venueRegisterEmailLabel.
  ///
  /// In es, this message translates to:
  /// **'Correo electrónico'**
  String get venueRegisterEmailLabel;

  /// No description provided for @venueRegisterEmailHint.
  ///
  /// In es, this message translates to:
  /// **'correo@ejemplo.com'**
  String get venueRegisterEmailHint;

  /// No description provided for @venueRegisterPasswordLabel.
  ///
  /// In es, this message translates to:
  /// **'Contraseña'**
  String get venueRegisterPasswordLabel;

  /// No description provided for @venueRegisterPasswordHint.
  ///
  /// In es, this message translates to:
  /// **'Mínimo 6 caracteres'**
  String get venueRegisterPasswordHint;

  /// No description provided for @venueRegisterPhoneLabel.
  ///
  /// In es, this message translates to:
  /// **'Teléfono de contacto'**
  String get venueRegisterPhoneLabel;

  /// No description provided for @venueRegisterPhoneHint.
  ///
  /// In es, this message translates to:
  /// **'+34 600 000 000'**
  String get venueRegisterPhoneHint;

  /// No description provided for @venueRegisterCityHint.
  ///
  /// In es, this message translates to:
  /// **'Ej. Madrid'**
  String get venueRegisterCityHint;

  /// No description provided for @venueRegisterWebsiteLabel.
  ///
  /// In es, this message translates to:
  /// **'Web (opcional)'**
  String get venueRegisterWebsiteLabel;

  /// No description provided for @venueRegisterWebsiteHint.
  ///
  /// In es, this message translates to:
  /// **'https://...'**
  String get venueRegisterWebsiteHint;

  /// No description provided for @venueRegisterSubmitting.
  ///
  /// In es, this message translates to:
  /// **'Registrando...'**
  String get venueRegisterSubmitting;

  /// No description provided for @venueRegisterCreateAccount.
  ///
  /// In es, this message translates to:
  /// **'Crear cuenta'**
  String get venueRegisterCreateAccount;

  /// No description provided for @venueRegisterLoginPrompt.
  ///
  /// In es, this message translates to:
  /// **'¿Ya tienes cuenta? Inicia sesión'**
  String get venueRegisterLoginPrompt;

  /// No description provided for @venueFormSavedSuccess.
  ///
  /// In es, this message translates to:
  /// **'Local guardado correctamente.'**
  String get venueFormSavedSuccess;

  /// No description provided for @venueFormEditTitle.
  ///
  /// In es, this message translates to:
  /// **'Editar local'**
  String get venueFormEditTitle;

  /// No description provided for @venueFormNewTitle.
  ///
  /// In es, this message translates to:
  /// **'Nuevo local'**
  String get venueFormNewTitle;

  /// No description provided for @venueFormSaving.
  ///
  /// In es, this message translates to:
  /// **'Guardando...'**
  String get venueFormSaving;

  /// No description provided for @venueFormSave.
  ///
  /// In es, this message translates to:
  /// **'Guardar local'**
  String get venueFormSave;

  /// No description provided for @venueFormSectionBasics.
  ///
  /// In es, this message translates to:
  /// **'Información del local'**
  String get venueFormSectionBasics;

  /// No description provided for @venueFormSectionLocation.
  ///
  /// In es, this message translates to:
  /// **'Ubicación'**
  String get venueFormSectionLocation;

  /// No description provided for @venueFormSectionContact.
  ///
  /// In es, this message translates to:
  /// **'Contacto y licencia'**
  String get venueFormSectionContact;

  /// No description provided for @venueFormSectionCompliance.
  ///
  /// In es, this message translates to:
  /// **'Capacidad y visibilidad'**
  String get venueFormSectionCompliance;

  /// No description provided for @venueFormFieldVenueName.
  ///
  /// In es, this message translates to:
  /// **'Nombre del local'**
  String get venueFormFieldVenueName;

  /// No description provided for @venueFormFieldDescription.
  ///
  /// In es, this message translates to:
  /// **'Descripción'**
  String get venueFormFieldDescription;

  /// No description provided for @venueFormFieldAddress.
  ///
  /// In es, this message translates to:
  /// **'Dirección'**
  String get venueFormFieldAddress;

  /// No description provided for @venueFormFieldPostalCodeOptional.
  ///
  /// In es, this message translates to:
  /// **'Código postal (opcional)'**
  String get venueFormFieldPostalCodeOptional;

  /// No description provided for @venueFormFieldContactEmail.
  ///
  /// In es, this message translates to:
  /// **'Email de contacto'**
  String get venueFormFieldContactEmail;

  /// No description provided for @venueFormFieldContactPhone.
  ///
  /// In es, this message translates to:
  /// **'Teléfono de contacto'**
  String get venueFormFieldContactPhone;

  /// No description provided for @venueFormFieldLicenseNumber.
  ///
  /// In es, this message translates to:
  /// **'Nº de licencia'**
  String get venueFormFieldLicenseNumber;

  /// No description provided for @venueFormFieldMaxCapacity.
  ///
  /// In es, this message translates to:
  /// **'Aforo máximo'**
  String get venueFormFieldMaxCapacity;

  /// No description provided for @venueFormFieldAccessibility.
  ///
  /// In es, this message translates to:
  /// **'Información de accesibilidad'**
  String get venueFormFieldAccessibility;

  /// No description provided for @venueFormVisibleToMusicians.
  ///
  /// In es, this message translates to:
  /// **'Visible para músicos'**
  String get venueFormVisibleToMusicians;

  /// No description provided for @venueFormVisibleToMusiciansHint.
  ///
  /// In es, this message translates to:
  /// **'Si está desactivado, solo lo verá tu equipo.'**
  String get venueFormVisibleToMusiciansHint;

  /// No description provided for @venueValidationRequired.
  ///
  /// In es, this message translates to:
  /// **'Requerido'**
  String get venueValidationRequired;

  /// No description provided for @venueValidationEmailInvalid.
  ///
  /// In es, this message translates to:
  /// **'Email no válido'**
  String get venueValidationEmailInvalid;

  /// No description provided for @venueValidationPositiveInt.
  ///
  /// In es, this message translates to:
