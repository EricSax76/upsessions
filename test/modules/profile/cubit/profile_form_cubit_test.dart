...
class MockAffinityOptionsRepository extends Mock
    implements AffinityOptionsRepository {}

class MockArtistImageRepository extends Mock implements ArtistImageRepository {}
...
void main() {
  group('ProfileFormCubit', () {
    ...
    late MockArtistImageRepository artistImageRepository;
    ...
    blocTest<ProfileFormCubit, ProfileFormState>(
      ...
      setUp: () {
        when(
          () => affinityRepository.fetchArtistOptionsForStyle('Jazz'),
      ...
      expect: () => [
        ...
        isA<ProfileFormState>()
            .having((s) => s.selectedStyle, 'selectedStyle', 'Jazz')
            .having((s) => s.suggestedArtists, 'suggestions', [
              'Miles Davis',
              'John Coltrane',
            ])
            .having((s) => s.isLoadingSuggestions, 'loading', false),
    ...
    blocTest<ProfileFormCubit, ProfileFormState>(
      ...
      expect: () => [
        isA<ProfileFormState>().having((s) => s.influences, 'influences', {
          'Rock': ['Queen', 'Bon Jovi'],
        }),
      ],
    );
